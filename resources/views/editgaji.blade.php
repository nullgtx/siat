      ...
      @foreach($gajikaryawan as $gaji)
        ...
        <input type="hidden" name="id" value="{{ $gaji->id }}">
          <div class="form-group row">
            ...
            <div class="col-9">
              <input type="date" id="tanggal" value="{{$gaji->tanggal}}"class="form-control">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-9">
              <input class="form-control" type="text" placeholder="Nama Karyawan" id="namakaryawan" value="{{$gaji->namakaryawan}}" required>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-9">
              <input class="form-control" type="text" placeholder="ID Karyawan" id="idkaryawan" value="{{$gaji->idkaryawan}}" required>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-9">
              <input class="form-control" type="text" placeholder="Jabatan Karyawan" id="jabatan" value="{{$gaji->jabatan}}" required>  
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-9">
              <input class="form-control" type="number" placeholder="Jumlah ketidakhadiran (alfa)" id="jumlahalfa"  required>
            </div>
          </div>
              ...
              <div class="input-group">
                <div class="input-group-prepend">
                  <span class="input-group-text">Rp.</span>
                    ...
                    <input type="number" class="form-control" id="gajipokok" placeholder="Masukkan Gaji Pokok" value="{{$gaji->gajipokok}}" required>
            ...
            <div class="col-9">
              <div class="input-group">
                <div class="input-group-prepend">
                  ...
                  <input type="number" class="form-control" id="potongan" placeholder="Masukkan Potongan Gaji" value="{{$gaji->potongan}}" required>
                <div class="input-group-append">
                  <span class="input-group-text">,00</span>
                </div>
              </div>
            ...
            <div class="col-9">
              <div class="input-group">
                <div class="input-group-prepend">
                  ...
                  <input type="number" class="form-control" id="tunjangan" placeholder="Masukkan Gaji Tunjangan" value="{{$gaji->tunjangan}}" required>
                <div class="input-group-append">
                  <span class="input-group-text">,00</span>
                </div>
              </div>
            ...
            <div class="col-9">
              <div class="input-group">
                <div class="input-group-prepend">
                  ...
                  <input type="number" class="form-control" id="gajiakhir" placeholder="Masukkan Total Gaji" value="{{$gaji->gajiakhir}}" required>
                <div class="input-group-append">
                  <span class="input-group-text">,00</span>
                </div>
              </div>
